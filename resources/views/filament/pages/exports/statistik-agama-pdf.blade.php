...
<body>
    ...
    <table>
        <thead>
            ...
            <tr>
                <th width="7%">L</th> <th width="7%">P</th> <th width="8%" class="bg-blue">Jml</th>
                <th width="7%">L</th> <th width="7%">P</th> <th width="8%" class="bg-green">Jml</th>
                <th width="7%">L</th> <th width="7%">P</th> <th width="8%" class="bg-purple">Jml</th>
            </tr>
        </thead>
        <tbody>
            @foreach($data as $row)
