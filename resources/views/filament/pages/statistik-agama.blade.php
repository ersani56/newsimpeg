<x-filament::page>
    ...
    <style>
        ...
        .btn-excel { background-color: #1e293b; }
        .table-wrapper { background: white; overflow-x: auto; border-radius: 0 0 0.5rem 0.5rem; }
    </style>
    @endpush
    ...
    <div class="statistik-card">
        <div class="statistik-header">
            <div>☀️ STATISTIK PEGAWAI PER AGAMA</div>
        ...
        <div class="table-wrapper">
            <table class="custom-statistik-table" id="agama-table">
                <thead>
                    <tr>
                        <th rowspan="2" class="text-left">Agama</th>
                        <th colspan="3">PNS</th>
    ...
    <script>
        function exportToExcel() {
            const table = document.getElementById('agama-table');
            const wb = XLSX.utils.book_new();
            const ws = XLSX.utils.table_to_sheet(table);
            XLSX.utils.book_append_sheet(wb, ws, 'Statistik Agama');
            XLSX.writeFile(wb, 'statistik_agama_' + new Date().getTime() + '.xlsx');
        }
    </script>
</x-filament::page>
